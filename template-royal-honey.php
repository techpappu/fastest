...
<section class="hero">
    <div class="hero-content">
        <div class="logo">অর্ডার করতে সরাসরি কল করুন <br> <a href="tel:8809613826917">8809613826917</a></div>
...
<section class="trust-section">
    ...
    <p class="trust-text">
        বিশেষ সময়ের জন্য কি খুঁজছেন একটু বাড়তি শক্তি? তাহলে শুনে নিন এক মিনিটে Royal Honey এর রাজকীয় কথা!" Royal Honey শুধু রাজাদের জন্য না বরং আপনার ভেতরের রাজাকে জাগিয়ে তোলার জন্য!
    </p>
</section>
        ...
        <div class="features-grid">
            <div>
                <div class="feature-item">
                    <span>Royal Honey – থাইল্যান্ডের এর proven formulay তৈরী একটা শক্তির বোমা।</span>
                </div>
                <div class="feature-item">
            ...
            <div class="product-image-container">
                <div class="product-image" style="background: #D4AF37; padding: 20px; border-radius: 10px;">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/royal-honey.webp" width="100%" height="auto" alt="Royal Honey">
                </div>
            </div>
        </div>
    ...
    <div class="container" style="width:100%">
        <div class="gallery-grid">
            <div class="gallery-item">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/Rayal-Honey12.webp" alt="">
            </div>
            <div class="gallery-item">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/Rayal-Honey21.webp" alt="">
            </div>
            <div class="gallery-item">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/Rayal-Honey200.webp" alt="">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="info-card">
            <ul class="info-list">
                ...
                <p>Royal Honey হলো প্রাকৃতিক মধুর সাথে বাছাই করা ভেষজ ও পুষ্টিকর উপাদানের সমন্বয়ে তৈরি একটি বিশেষ ফর্মুলা। এটি শরীরের প্রাকৃতিক শক্তি, সহনশীলতা ও দৈনন্দিন এনার্জি সাপোর্ট করতে সাহায্য করে।</p>
                <li>রয়াল মধু কি?</li>
...
<section class="order-section" id="order">
    <div class="container">
        <?php the_content(); ?>
        <div class="logo" style="text-align:center;">অর্ডার করতে সরাসরি কল করুন <br> <a href="tel:8809613826917">8809613826917</a></div>
    </div>
</section>
...
<script>
	...
	if(document.body.classList.contains("woocommerce-order-received")) {
		...
		var youtubeVideoID = "1tY0wI9yGZ0"; 
	}
