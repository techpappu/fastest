...
/**
 * Template name: Funnel Adult two
 *
...
<section class="hero">
    <div class="hero-content">
        ...
        <div class="product-image" style="background: #e44708; padding: 5px; border-radius: 10px;max-width:350px;">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/imgi_8_poster-9-y.webp" style="width:100%; height:auto;border-radius:5px;" alt="Royal Honey">
        </div>
