...
?>
   ...
   <section class="trust-section">
      ...
      <p class="trust-text">
         আজকের অফার মূল্য ১২৫০-২৫৫০/= টাকা থেকে ট্রায়াল কোর্স শুরু
      </p>
      ...
      <div class="container">
         ...
         <section class="countdown">
            ...
            <div class="price regular">
               রেগুলার মূল্যঃ <span class="strike">১৫৫০</span> টাকা
            </div>

            <div class="price discount">
               ডিসকাউন্ট মূল্যঃ মাত্র <span class="highlight">১২৫০</span> টাকা থেকে শুরু
            </div>
         </section>
